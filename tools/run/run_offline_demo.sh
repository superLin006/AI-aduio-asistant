...
RUNTIME_PACKAGE=${RUNTIME_PACKAGE:-/home/xh/itc_project/deliver/deliver_dispatch_sdk_v10_w8bf16}

export LD_LIBRARY_PATH="$BUILD_DIR/sdk:$SHERPA_INSTALL/lib:$RUNTIME_PACKAGE/lib:/opt/sophon/libsophon-current/lib:${LD_LIBRARY_PATH:-}"
exec "$BUILD_DIR/sdk/ai_audio_offline_demo" \
  --bmodel "$MODEL_ZOO/models/BM1684X/qwen3_asr_merged_w4g64.bmodel" \
  --tokenizer "$MODEL_ZOO/models/qwen3-asr-0.6b" \
